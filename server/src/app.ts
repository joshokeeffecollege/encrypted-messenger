...
import { federationRoutes, webFingerRoutes } from "./federation/federation-routes.js";
...
// Main Express file.
// This mostly sets up middleware and plugs in the route files.
...
app.listen(Number(PORT), HOST, () => console.log(`Server running on ${serverUrl}`));
