...
import { cleanServerUrl } from "../app/server.ts";
...
export const SimpleAuthForm: React.FC<SimpleAuthFormProps> = ({
  ...
  // both login and register use this form
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    // dont do anything if server box is empty
    ...
    try {
      // parent file decides what submit means
