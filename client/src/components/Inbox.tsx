...
export const Inbox: React.FC<InboxProps> = ({ user, onOpenChat }) => {
  ...
  async function loadConversations() {
    ...
    try {
      const inbox = await apiGet<MessageDTO[]>("/inbox");
      ...
      for (const msg of inbox) {
        ...
        const preview = isSender ? `You: ${msg.ciphertext}` : msg.ciphertext;
    ...
    <div className="inbox-view">
      ...
      <div className="mb-4 border rounded-3 p-3 bg-light">
        ...
        <p className="small text-muted mb-2">
          Type a username to start a conversation. They&apos;ll see your message
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    <div className="d-flex justify-content-between">
                      <span className="fw-semibold">{conv.peerUsername}</span>
